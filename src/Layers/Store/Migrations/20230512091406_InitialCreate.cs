        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carrier_AspNetUsers_IdentityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipper_AspNetUsers_IdentityId",
                        column: x => x.IdentityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LoadingType = table.Column<string>(type: "text", nullable: false),
                    ...
                    IsInWork = table.Column<bool>(type: "boolean", nullable: false),
                    Carrying = table.Column<int>(type: "integer", nullable: false),
                    Volume = table.Column<int>(type: "integer", nullable: false),
                    Rate = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrierSlot", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarrierSlot_Carrier_CarrierId",
                        column: x => x.CarrierId,
                        principalTable: "Carrier",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarrierSlot_Shipper_ShipperId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipperSlot", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipperSlot_Carrier_CarrierId",
                        column: x => x.CarrierId,
                        principalTable: "Carrier",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShipperSlot_Shipper_ShipperId",
                        column: x => x.ShipperId,
                        principalTable: "Shipper",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carrier_IdentityId",
                table: "Carrier",
                column: "IdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_CarrierSlot_CarrierId",
                table: "CarrierSlot",
                column: "CarrierId");

            migrationBuilder.CreateIndex(
                name: "IX_CarrierSlot_ShipperId",
                table: "CarrierSlot",
                column: "ShipperId");

            migrationBuilder.CreateIndex(
                name: "IX_Shipper_IdentityId",
                table: "Shipper",
                column: "IdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipperSlot_CarrierId",
                table: "ShipperSlot",
                column: "CarrierId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipperSlot_ShipperId",
                table: "ShipperSlot",
                column: "ShipperId");
        }
